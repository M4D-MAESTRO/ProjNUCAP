...
public class DBService {
	...
	public void instantiateDataBase() {
		...
		instituicaoRep.saveAll(Arrays.asList(gambiarra, escola, empresaQuali, empresa));
		  ...
		  Aprendiz apr1 = new Aprendiz("Pedro Augusto de Assis", "(21) 9533-33331", null,"lhccorrea@hotmail.com" , "041.251.478-56", data, "011.225.445-55", "(21) 9999-99999", null , null, pe.encode("senha4"));
		  apr1.addPerfil(Perfil.ADMIN);
		  
		  Aprendiz apr2 = new Aprendiz("Wendel Dias Reis", "(21) 9533-33331", null,"diasreis@gmail.com" , "041.251.478-56", data, "011.225.445-55", "(21) 9999-99999", null , null, pe.encode("senha5"));
