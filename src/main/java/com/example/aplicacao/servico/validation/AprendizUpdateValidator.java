...
public class AprendizUpdateValidator implements ConstraintValidator<AprendizUpdate, AprendizDTO> {
	...
	@Autowired
	private PessoaRepository teste;
	

	@Override
	public void initialize(AprendizUpdate ann) {
	}

	@Override
	public boolean isValid(AprendizDTO objDto,  ConstraintValidatorContext context) {
