...
public class ProjNucapApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Instituicao escola = new Instituicao("Centro Educacional Futuro Certo", "21 988554525",end2 , "25.561.654/6321-68", Salvamento.getCodInstituicao(aux));
		instituicaoRep.saveAll(Arrays.asList(escola));
		
		aux = instituicaoRep.count(); 
		Instituicao empresaQuali = new Instituicao("Fundação Cursos Oliveira", "21 2141-5522", end2, "44.775/5522-11",  Salvamento.getCodInstituicao(aux));
		instituicaoRep.saveAll(Arrays.asList(empresaQuali));
		
		aux = instituicaoRep.count(); 
		Instituicao empresa = new Instituicao("Restaurante Sabor Total", "21 95663-2541", end2, "21.252.656/5889-95",  Salvamento.getCodInstituicao(aux));
